"""
Base Django settings for TakeOFF Driver Onboarding Platform.
"""
import os
...
# Read .env file if it exists (looks in backend/ dir)
_env_file = os.path.join(BASE_DIR, '.env')
if os.path.exists(_env_file):
    environ.Env.read_env(_env_file)

# Security
SECRET_KEY = env('SECRET_KEY', default='django-insecure-placeholder-change-in-production')
DEBUG = env('DEBUG')
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for the TakeOFF Driver Onboarding Platform',
    'VERSION': '1.0.0',
